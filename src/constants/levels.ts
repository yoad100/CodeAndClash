...
const BASE_LEVELS: Array<Omit<LevelTheme, 'tier'>> = [
  ...
  },
  {
    key: 'architect',
    name: 'Architect',
  gradient: ['#fef3c7', '#fcd34d', '#f59e0b', '#d97706'] as const,
    ...
    icon: 'aperture',
    particleColors: ['rgba(234,179,8,0.5)', 'rgba(253,224,71,0.45)', 'rgba(251,191,36,0.45)'],
    beam: 'rgba(253,224,71,0.26)',
  },
  {
    key: 'expert',
    name: 'Expert',
  gradient: ['#dbeafe', '#bfdbfe', '#60a5fa', '#1d4ed8'] as const,
    border: 'rgba(37,99,235,0.65)',
    glow: 'rgba(29,78,216,0.35)',
    text: '#0a1f4d',
    shimmer: 'rgba(191,219,254,0.65)',
    accent: 'rgba(96,165,250,0.55)',
    icon: 'diamond',
    particleColors: ['rgba(37,99,235,0.45)', 'rgba(96,165,250,0.5)', 'rgba(191,219,254,0.45)'],
    beam: 'rgba(96,165,250,0.24)',
  },
  {
    key: 'lead',
    name: 'Lead',
  ...
  },
  {
    key: 'senior',
    name: 'Senior',
  gradient: ['#dcfce7', '#bbf7d0', '#4ade80', '#16a34a'] as const,
    ...
    icon: 'leaf-outline',
    particleColors: ['rgba(74,222,128,0.4)', 'rgba(134,239,172,0.4)', 'rgba(217,249,157,0.35)'],
    beam: 'rgba(134,239,172,0.2)',
  },
  {
    key: 'specialist',
    name: 'Specialist',
  gradient: ['#fdf2f8', '#fbcfe8', '#f472b6', '#be185d'] as const,
    border: 'rgba(244,114,182,0.6)',
    glow: 'rgba(190,24,93,0.32)',
    text: '#44071e',
    shimmer: 'rgba(251,207,232,0.55)',
    accent: 'rgba(244,114,182,0.42)',
    icon: 'flower',
    particleColors: ['rgba(236,72,153,0.38)', 'rgba(244,114,182,0.38)', 'rgba(252,165,165,0.35)'],
    beam: 'rgba(244,114,182,0.18)',
  },
  {
    key: 'mid',
    name: 'Mid-level',
